...
const CreateAccount = () => {
    ...
    return (react_1.default.createElement("form", { onSubmit: (e) => handleSubmit(e) },
        ...
        react_1.default.createElement(Flex_1.Flex, { flexDirection: 'flex-col' },
            react_1.default.createElement(index_1.Input, { name: 'userName', onChange: handleChange }),
            react_1.default.createElement(index_1.Input, { name: 'password', onChange: handleChange }),
            react_1.default.createElement(index_1.Input, { name: 'email', onChange: handleChange }),
