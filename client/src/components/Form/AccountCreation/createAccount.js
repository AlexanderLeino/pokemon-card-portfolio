...
var index_1 = __importDefault(require("../../Input/index"));
...
var CreateAccount = function () {
    var _a = (0, react_1.useState)({
        ...
        lastName: '',
        email: '',
    }), accountInfo = _a[0], setAccountInfo = _a[1];
    ...
    var handleChange = function (e) {
        var _a;
        setAccountInfo(__assign(__assign({}, accountInfo), (_a = {}, _a[e.target.name] = e.target.value, _a)));
    };
    return (react_1.default.createElement("form", { onSubmit: function (e) { return handleSubmit(e); } },
        ...
        react_1.default.createElement(Flex_1.default, { flexDirection: 'flex-col' },
            react_1.default.createElement(index_1.default, { name: 'userName', onChange: handleChange }),
            react_1.default.createElement(index_1.default, { name: 'password', onChange: handleChange }),
            react_1.default.createElement(index_1.default, { name: 'email', onChange: handleChange }),
